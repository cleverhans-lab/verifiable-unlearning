...
trials_dir = Path("/root/verifiable-unlearning/evaluation/trials/datasets")
...
rows = [
    ['Creditscore && $100 $&$ 6$', 'analcatdata_creditscore', '\\\\'],
    ['\\rule{0pt}{2ex}%<--- do not remove','\\\\'],
    ['Patient &&  $88 $&$ 8$', 'postoperative_patient_data', '\\\\'],
    ['\\rule{0pt}{2ex}%<--- do not remove','\\\\'],
    ['Cy Young &&  $92 $&$ 10$', 'analcatdata_cyyoung9302', '\\\\'],
    ['\\rule{0pt}{2ex}%<--- do not remove','\\\\'],
    ['Corral && $160 $&$ 6$', 'corral', '\\\\'],
    ['\\rule{0pt}{2ex}%<--- do not remove','\\\\'],
    ['Lawsuit && $264 $&$ 4$ ', 'analcatdata_lawsuit', '\\\\'],
    ['\\rule{0pt}{2ex}%<--- do not remove','\\\\'],
    ['Breast cancer && $286 $&$ 9$ ', 'breast_cancer', '\\\\'],
    ['\\rule{0pt}{2ex}%<--- do not remove','\\\\'],
    ['Monk3 && $554 $&$ 6$ ', 'monk3', '\\\\'],
]
